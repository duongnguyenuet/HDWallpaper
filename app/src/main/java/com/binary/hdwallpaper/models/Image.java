...
public class Image {
    ...
    public Image(String id, String catId, String wallpaperImage, String wallpagerImageThumb, String totalViews, String cId, String categoryName, String categoryImage, String categoryImageThumb, String totalWallpager) {
        this.id = id;
        this.catId = catId;
